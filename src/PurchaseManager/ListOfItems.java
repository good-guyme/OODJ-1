...
public class ListOfItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 6, 794, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 157, 788, 346));
        ...
        getContentPane().add(idtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(96, 118, 115, 27));
        ...
        getContentPane().add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(713, 120, -1, -1));
        ...
        getContentPane().add(searchButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(217, 120, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PurchaseManager/Image/background.png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 510));
