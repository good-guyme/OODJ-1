...
public class PaymentStatus extends javax.swing.JFrame {
    ...
    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
        try {
            // File to which data will be added
            String filename = "status.txt";
            FileWriter fw = new FileWriter(filename, true); // Append mode

            // Prepare data to add
            String newData = T1.getText() + ";"
                    + T2.getText() + ";"
                    + T3.getSelectedItem() + ";\n";

            // Write the new data with a newline character
            fw.write(newData);
            fw.close();
    ...
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b3ActionPerformed
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) tbl1.getModel();
            String itemIdToDelete = model.getValueAt(selectedRow, 0).toString();
            ...
            // Read the file and rebuild the content, excluding the row to delete
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (parts[0].equals(itemIdToDelete)) {
                    itemFound = true;
                    continue; // Skip this line (the one to delete)
                }
